...
public class GameManager : MonoBehaviour {
    ...
    public void SpawnPlayer() {
        if (player != null)
            return;
        Vector3Int raycastStartposition = new Vector3Int(world.chunkSize / 2, world.chunkHeight, world.chunkSize / 2);
        RaycastHit hit;
        if (Physics.Raycast(raycastStartposition, Vector3.down, out hit, 130)) {
